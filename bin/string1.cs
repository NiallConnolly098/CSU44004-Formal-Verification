// Dafny program string1.dfy compiled into C#
...
// Command-line arguments: build --output bin\string1 c:\Users\niall\Documents\4th Year\FormalVerification\string1.dfy
// string1.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      bool res = false;
      if ((new BigInteger((pre).Count)).Sign == 0) {
        res = true;
        return res;
      }
      if ((new BigInteger((str).Count)) < (new BigInteger((pre).Count))) {
        res = false;
        return res;
      }
    ...
    public static bool haveCommonKSubstring(BigInteger k, Dafny.ISequence<Dafny.Rune> str1, Dafny.ISequence<Dafny.Rune> str2)
    {
      ...
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      while ((_0_i) < (new BigInteger((str1).Count))) {
        if ((new BigInteger(((str1).Drop(_0_i)).Count)) < (k)) {
          found = false;
          return found;
        }
        BigInteger _1_index;
        ...
        bool _2_subFound;
        bool _out0;
        _out0 = __default.isSubstring((str1).Subsequence(_0_i, _1_index), str2);
        _2_subFound = _out0;
        if (_2_subFound) {
          found = true;
          return found;
